"""
Data preparation step 1: Filter CrossDocked2020 by RMSD threshold.
...
if __name__ == '__main__':
    ...
    with open(types_path, 'r') as f:
        for ln in tqdm(f.readlines()):
            ...
            ligand_save_fn = ligand_fn[:ligand_fn.rfind('.')] + '.sdf'
    ...
    print(f'Done. {len(index)} protein-ligand pairs saved to {args.dest}')
